...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        it('URL for feeds is defined and not empty', function() { 
        ...
        it('Name for feeds is defined and not empty', function() {
            allFeeds.forEach( function(feed) {
    ...
    describe('Initial Entries', function() {
        /* ODO: Test that ensures when the loadFeed
    ...
    describe('New Feed Selection', function() {
        ...
        it('Feed content changes', function() {
            feedAfter = $('.feed').html();
            //compares with old and new html content of feed to test.
